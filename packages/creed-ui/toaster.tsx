...
export function Toaster() {
  return (
    <SonnerToaster
      ...
      // Glide (not jump) when the "Get started" card expands underneath:
      // the card writes --getting-started-offset onto this stack the moment
      // it starts animating, and this transition matches the card's reveal
      // (260ms, same easing) so both move together.
      className="!transition-[bottom] !duration-[260ms] !ease-[cubic-bezier(0.22,1,0.36,1)]"
