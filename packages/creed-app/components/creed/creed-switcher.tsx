...
const TITLE_CLASS =
  "font-heading text-[1.22rem] font-medium leading-none tracking-[-0.03em] text-[var(--creed-text-primary)] md:text-[1.45rem]";
...
export function CreedSwitcher() {
  ...
  return (
    <>
      <DropdownMenu>
        <div className="inline-flex h-8 max-w-full min-w-0 items-center gap-2.5">
