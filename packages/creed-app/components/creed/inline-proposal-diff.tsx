...
function StaleProposalAction({ onDismiss }: { onDismiss: () => void }) {
  return (
    <button
      ...
      className="-mr-1 inline-flex h-7 items-center rounded-md bg-[var(--creed-accent)] px-2.5 text-sm font-medium text-white transition-colors hover:bg-[var(--creed-accent-hover)]"
    >
      Dismiss
    </button>
  );
