...
function SaveStatus() {
  ...
  return (
    <div
      className={`mt-2 flex h-5 w-max items-center gap-2 text-sm transition-colors duration-200 ${content.tone}`}
      aria-live="polite"
    >
      <AnimatePresence initial={false}>
        <motion.span
    ...
    <>
      <div className="relative flex h-full min-h-0 bg-[var(--creed-surface)] transition-colors duration-200">
        <div className="min-w-0 flex-1">
          ...
          >
            <div className={cn(FILE_COLUMN_CLASS, "pb-28 md:pb-10")}>
              <FileStickyHeader>
                <FileStickyHeaderRow>
                  <div className="min-w-0 flex-1">
                    <CreedSwitcher />
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            ...
                            className={cn(
                              FILE_HEADER_OUTLINE_MOBILE_FOCUS_CLASS,
                              "group/vcsplit border-[var(--creed-border)] bg-[var(--creed-surface)] data-[state=open]:bg-[var(--creed-surface-raised)]",
                            )}
...
function proposedNewSectionChrome(proposal: Proposal) {
  const draft =
    proposal.draft.kind === "new-section" ? proposal.draft : null;
...
const ActivityRow = memo(function ActivityRow({
  ...
  return (
    <div className="group rounded-lg border border-[var(--creed-border)] bg-[var(--creed-surface)] p-3 transition-colors duration-150 hover:bg-[var(--creed-surface-raised)]">
