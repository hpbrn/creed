...
export function CreedPanel({
  ...
  const mobileInputIcon = useAnimatedIconControls();
          ...
          <motion.div ref={bodyRefForHeight} animate={shakeControls}>
            <div className="flex items-center gap-2.5 border-b border-[var(--creed-border)] px-4">
              <button
                type="button"
                onClick={cycleMode}
                onMouseEnter={mobileInputIcon.start}
                onMouseLeave={mobileInputIcon.settle}
              ...
              >
                <InputIcon
                  ref={mobileInputIcon.iconRef}
                  size={16}
                  className="inline-flex h-4 w-4 shrink-0 items-center justify-center leading-none"
                />
              </button>
              <span
                className="hidden size-4 shrink-0 items-center justify-center text-[var(--creed-text-tertiary)] md:inline-flex"
              ...
              {mode === "search" ? (
                <input
                  ...
                  spellCheck={false}
                  autoComplete="off"
                  className="h-10 w-full bg-transparent text-[15px] text-[var(--creed-text-primary)] outline-none placeholder:text-[var(--creed-text-tertiary)]"
                />
              ) : (
                <MentionInput
                  key={mode}
              ...
              showSmartFind ? (
                <div className="p-1.5">
                  <button
                    ...
                    className={cn(PANEL_COMMAND_ROW_CLASS, "bg-accent text-accent-foreground")}
                  >
                    <span className="truncate">
                    ...
                    {agentRun.status === "result" && agentRun.result ? (
                      <>
                        ...
                        <button
                          ...
                          className={cn(PANEL_COMMAND_ROW_CLASS, "mt-0.5 bg-accent text-accent-foreground")}
                        >
                          <span className="truncate">
                      ...
                      <>
                        ...
                        {outOfCredits ? (
                          <button
                            ...
                            className={cn(
                              PANEL_COMMAND_ROW_CLASS,
                              "mt-1 text-[var(--creed-text-secondary)] transition-colors duration-150 hover:bg-accent hover:text-accent-foreground",
                            )}
                          >
                            Add credits
                          </button>
