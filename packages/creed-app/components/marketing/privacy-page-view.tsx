...
const cloudSections: PrivacySection[] = [
  {
    ...
    paragraphs: [
      "This policy applies to people who use Creed, including people who create an account, connect agents, submit or review proposals, or otherwise use the service.",
    ],
  },
  {
    id: "controller",
  ...
  },
  {
    ...
    bullets: [
      "directly from you when you sign in, edit your Creed, manage connections, or use account features",
