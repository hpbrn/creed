  ...
  return (
    <SkeletonScreen className="overscroll-contain">
      <div className="relative mx-auto max-w-[920px] px-4 pb-28 md:px-12 md:pb-10 xl:px-16">
        <div className="sticky top-0 z-20 mb-6 -mx-4 bg-[color:var(--creed-surface)]/95 px-4 py-3 backdrop-blur-sm [overflow-anchor:none] md:-mx-12 md:mb-8 md:px-12 xl:-mx-16 xl:px-16">
