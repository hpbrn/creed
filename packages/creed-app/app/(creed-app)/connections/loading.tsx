...
// ConnectionsScreen + McpHealthDashboard: the max-w-[960px] column, one full-width
// Setup card (rounded-xl p-4/md:p-5), the Agents grid of rounded-lg p-4
// connection cards, then Health at mt-12 with its four rounded-lg p-4 stat
// tiles, the 240px activity chart, and the 180px/200px chart pair.
