...
export function GoogleSignInButton({
  ...
  // pass `/file` so the user lands in the app (unpaid users are sent to
  // /pricing by the app gate). `/payment/success` also passes `/file`.
  // When omitted, the callback's existing default (root redirect) applies.
  redirectTo?: string;
}) {
