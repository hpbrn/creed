...
// whether a personal Creed row exists. Missing rows are provisioned, then
// the user enters `/file`.
//
...
export default async function Home() {
  ...
  // access is sent to /pricing. Access is either a personal entitlement OR
  // membership of a shared Creed whose billing is live.
