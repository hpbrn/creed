...
export async function POST(request: Request) {
  ...
  // Cancel always returns to pricing. Buyers who started on /pricing stay
  // there after success; everyone else continues into the app.
  const fromPricing =
    body.returnTo === "/pricing" || body.returnTo === "pricing";
  const returnTo = "/pricing";
  const successNext = fromPricing ? "/pricing" : "/file";
