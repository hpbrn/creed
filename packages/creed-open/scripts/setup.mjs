...
const ownerSecret = isOwnerCode(values.CREED_OWNER_SECRET)
...
stdout.write(
  `Creed Open is ready.\n\nYour owner code is ${formatOwnerCode(ownerSecret)}. Enter it once at http://localhost:3001. It is also in apps/open/.env.local.\n\nRun npm run dev\nOpen http://localhost:3001\n`,
);
