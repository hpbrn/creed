...
import type { ActivityStatus } from "@/lib/creed/creed-data";
import { cn } from "@/components/ui/utils";

export type ActivityFilterValue =
  "all" | Exclude<ActivityStatus, "pending" | "stale">;
...
export function getActivityFilterTone(
  value: ActivityFilterValue,
): ActivityFilterTone {
...
export function getActivityStatusStyles(status: ActivityStatus) {
  ...
  if (status === "stale") {
    return "bg-[#F3E8FF] text-[#6D28D9] dark:bg-[#3b0764]/40 dark:text-[#c4b5fd]";
  }
