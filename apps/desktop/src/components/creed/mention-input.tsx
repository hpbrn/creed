...
import type { AccentKey } from "@/lib/creed/creed-data";
    ...
    return (
      <div className="relative flex-1">
        ...
        <div
          ...
          className="min-h-8 w-full whitespace-pre-wrap break-words py-1.5 text-[15px] leading-[1.4] text-[var(--creed-text-primary)] outline-none"
        />
