...
export function FileLoading() {
  return (
    <SkeletonScreen className="overscroll-contain">
      <div className="relative mx-auto max-w-[920px] px-4 pb-28 md:px-12 md:pb-10 xl:px-16">
        <div className="sticky top-0 z-20 mb-6 -mx-4 bg-[var(--creed-surface)] px-4 py-3 [overflow-anchor:none] md:-mx-12 md:mb-8 md:px-12 xl:-mx-16 xl:px-16">
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-3">
                    <SkeletonBar className="h-[calc((1cap+36px)/2)] w-1 shrink-0 rounded-[1.25px] text-[1.22rem] md:text-[1.45rem]" />
