  ...
  return (
    ...
    >
      <div
        className={cn(
          nestedPlateRadius,
          "relative flex min-w-0 items-center justify-center overflow-hidden p-4 sm:p-6 [overflow-anchor:none]",
          // Shorter than square at the 3-up desktop width so the coloured
          // plates hug the demos. Auto height when the grid is one column.
          square ? "lg:aspect-[5/4]" : "min-h-[380px] flex-1",
          plateClassName,
        )}
