...
// answer regardless of which item is expanded. Chevron rotation uses the
// Tailwind v4 `rotate` property, so the transition list must include it.
        ...
        return (
          ...
          >
            ...
            >
              ...
              <ChevronDown
                className={cn(
                  "h-4 w-4 shrink-0 origin-center text-[var(--creed-text-tertiary)] transition-[color,transform,rotate] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:text-[var(--creed-text-primary)]",
                  open && "rotate-180",
                )}
              />
            </button>
