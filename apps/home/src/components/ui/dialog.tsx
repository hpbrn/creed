      ...
      */}
      <DialogOverlay className={overlayClassName}>
        <DialogPrimitive.Content
          ...
          className={cn(
            "creed-scrollbar relative z-50 grid max-h-[calc(100dvh-2rem)] w-full max-w-[calc(100%-2rem)] gap-4 overflow-x-hidden overflow-y-auto rounded-[var(--radius-xl)] bg-popover p-5 text-sm text-popover-foreground ring-1 ring-foreground/8 shadow-[var(--creed-shadow-dialog)] duration-200 outline-none sm:max-w-sm data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=open]:slide-in-from-bottom-2 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=closed]:slide-out-to-bottom-2",
            className,
          )}
          {...props}
        >
